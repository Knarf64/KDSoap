...
public:
    ...
    // SOAP 1.2
    //TransformFaultException(const FaultCode &code, const QString &reason, const QStringList &subcodes, const QString &node, const QString &role, const TFMS__TransformFaultType &faultType);
    TransformFaultException(const FaultCode &code, const QString &reason, const TFMS__TransformFaultType &faultType, const QStringList &subcodes = QStringList(), const QString &node = QString(), const QString &role = QString());
